...
function Home() {
  return (
    <div name="// home" className="h-screen w-full flex flex-col justify-center md:flex md:flex-row md:items-center bg-gradient-to-b from-black to-gray-800">
      ...
      <img src={profile} alt="my profile" className="w-2/5 md:w-4/12 md:flex md:justify-center mx-auto rounded-full md:rounded-tl-[30%] md:rounded-tr-[70%] md:rounded-bl-[40%] md:rounded-br-[20%] shadow hover:shadow-white" />
